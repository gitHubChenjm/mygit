			...
			<div class="layui-form-item layui-form-text">
			 	<div class="layui-inline">
	     		 <label class="layui-form-label">满意度</label>
	   			 ...
	   			 <!-- 满意度,根据数据库，js获取回显 -->
				<input type="hidden"  id="evaluateValue" value="${service.evaluateId.value}"/>
	   		</div>
	   		<div class="layui-form-item layui-form-text">
				<label class="layui-form-label">服务结果</label>
				<div class="layui-input-block">
					<input type="text"  value="${service.request}" class="layui-input" readonly unselectable="on">	
				</div>

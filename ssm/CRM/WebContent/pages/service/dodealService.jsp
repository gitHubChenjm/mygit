		...
		<form id="form" class="layui-form"  method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<!-- 设置为归档 -->
					<input type="hidden" value="72" name="statusId.id"/>
			...
			<div class="layui-form-item layui-form-text">
				...
				<div class="layui-input-block">
					<textarea lay-verify="required" name="dealContent" placeholder="请输入内容" class="layui-textarea"></textarea>
				</div>
			</div>
			...
			<div class="layui-form-item layui-form-text">
				<div class="layui-inline">
	     		 <label class="layui-form-label">处理时间</label>
	      			<div class="layui-input-inline">
	       		 		<input type="text" id="dealDate" name="dealDate" class="layui-input" readonly unselectable="on">
	     			 </div>
	   			 </div>
    		</div>
